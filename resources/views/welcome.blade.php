		         ...
		         <div class="swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-1.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-2.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-3.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-4.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-5.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-6.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-7.jpg') }}" alt="screenshot">
                        </div>
                        <div class="swiper-slide">
                        	<img class="w-100" src="{{ asset('img/screenshot-8.jpg') }}" alt="screenshot">
                        </div>
                    </div>
                    <!-- Carousel Arrows -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 xs-padding">
                        <div class="blog-box">
                            <div class="blog-thumb">
                               <img src="{{ asset('img/blog-1.jpg') }}" alt="img">
                               <div class="post-meta">
                                    <div>
                    ...
                    <div class="col-md-4 col-sm-6 xs-padding">
                        <div class="blog-box">
                            <div class="blog-thumb">
                               <img src="{{ asset('img/blog-2.jpg') }}" alt="img">
                               <div class="post-meta">
                                    <div>
                                       <span><i class="fa fa-user"></i>By: Admin</span>
                                        <span><i class="fa fa-calendar"></i>Jan 01, 2018</span>
                    ...
                    <div class="col-md-4 col-sm-6 xs-padding">
                        <div class="blog-box">
                            <div class="blog-thumb">
                               <img src="{{ asset('img/blog-3.jpg')}}" alt="img">
                               <div class="post-meta">
                                    <div>
                                       <span><i class="fa fa-user"></i>By: Admin</span>
                                        <span><i class="fa fa-calendar"></i>Jan 01, 2018</span>
        ...
        <div id="subscribe" class="subscribe-section padding">
		    <div class="container text-center">
                <div class="subscribe-content">
                   <img class="logo" src="{{ asset('img/footer-Logo.png') }}" alt="logo"/>
